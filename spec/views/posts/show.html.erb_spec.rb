...
RSpec.describe 'posts/show.html.erb', type: :feature do
  before :each do
    ...
    @user2 = User.create(name: 'Batman', photo: 'https://picsum.photos/id/23/200', bio: 'Micronaut', posts_counter: 0)
    @user3 = User.create(name: 'Like', photo: 'https://picsum.photos/id/23/200', bio: 'Micronaut', posts_counter: 0)
    @post = Post.create(author: @user, title: 'Post 1', text: 'This is how', comments_counter: 0, likes_counter: 0)
    Comment.create(users: @user, posts: @post, text: 'Comment1')
    Comment.create(users: @user2, posts: @post, text: 'Comment2')
    Comment.create(users: @user3, posts: @post, text: 'Comment3')
