...
RSpec.describe 'users/show.html.erb', type: :feature do
  before :each do
    @user = User.create(name: 'Yemi', photo: 'https://picsum.photos/id/23/200', bio: 'Micronaut', posts_counter: 0)
    @post1 = Post.create(author: @user, title: 'Post 1', text: 'This is how', comments_counter: 0, likes_counter: 0)
    visit user_path(@user)
    Post.create(author: @user, title: 'Post 2', text: 'This is how', comments_counter: 0, likes_counter: 0)
    visit user_path(@user)
    Post.create(author: @user, title: 'Post 3', text: 'This is how', comments_counter: 0, likes_counter: 0)
    visit user_path(@user)
  end
  ...
  it "I can see the user's username" do
    expect(page).to have_content('Yemi')
  end
